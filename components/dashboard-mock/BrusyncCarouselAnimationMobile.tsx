...
const archivo = Archivo({
  ...
  variable: "--font-archivo-carousel-mobile",
  display: "swap",
});
...
const PAD = 64;
const FRAME = { x: PAD, y: 470, w: 1080 - PAD * 2, h: 700 };
...
function CarouselWindow({ T }: { T: number }) {
  ...
  return (
    <div style={{ position: "absolute", inset: 0, background: C.bg, overflow: "hidden" }}>
      ...
      >
        <div style={{ fontSize: 52, fontWeight: 700, color: C.ink, letterSpacing: "-0.02em" }}>
          {BRAND}
      ...
      <div
        style={{
          ...
          opacity: intro,
          transform: `translateY(${introY * 0.6}px)`,
        }}
      >
        O seu sistema,
        <br />
        ...
        {SLIDES.map((s, i) => {
          ...
          return (
            ...
            >
              ...
              <div style={{ fontSize: 30, color: C.dim, marginTop: 18, lineHeight: 1.32 }}>
                {s.benefit}
              </div>
            </div>
          );
      ...
      >
        {SLIDES.map((s, i) => {
          ...
          return (
            <div
              key={s.src}
              style={{ flex: 1, height: 8, background: C.rule, position: "relative" }}
            >
              <div
                style={{
                  position: "absolute",
      ...
      >
        <div style={{ fontSize: 26, fontWeight: 600, color: C.ink }}>brusync.com.br</div>
        <div
          style={{
            fontSize: 20,
            letterSpacing: "0.14em",
...
export function BrusyncCarouselAnimationMobile() {
  ...
  return (
    <div className={`brusync-carousel-frame-mobile ${archivo.variable}`} aria-hidden="true">
      <div className="brusync-carousel-stage-mobile" ref={stageRef}>
        <div
          style={{
            position: "absolute",
            left: 0,
            ...
            fontFamily: "var(--font-archivo-carousel-mobile), sans-serif",
          }}
        >
          <CarouselWindow T={T} />
        </div>
